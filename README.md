...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/jira-11.2.svg)](https://hub.docker.com/r/alvistack/jira-11.2)
...
- [`alvistack/jira-11.2`](https://hub.docker.com/r/alvistack/jira-11.2)
  - [`packer/docker-11.2/packer.json`](https://github.com/alvistack/docker-jira/blob/master/packer/docker-11.2/packer.json)
...
Start Atlassian Jira Server:
    ...
    # Pull latest image
    docker pull alvistack/jira-11.2
