...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/jira-11.3.svg)](https://hub.docker.com/r/alvistack/jira-11.3)
...
- [`alvistack/jira-11.3`](https://hub.docker.com/r/alvistack/jira-11.3)
  - [`packer/docker-11.3/packer.json`](https://github.com/alvistack/docker-jira/blob/master/packer/docker-11.3/packer.json)
...
Start Atlassian Jira Server:
    ...
    # Pull latest image
    docker pull alvistack/jira-11.3
