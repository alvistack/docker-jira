...
## Supported Tags and Respective `Dockerfile` Links
  ...
  - [`8.7`, `latest`](https://github.com/alvistack/docker-jira/blob/master/molecule/8.7/Dockerfile.j2)
  - [`8.6`](https://github.com/alvistack/docker-jira/blob/master/molecule/8.6/Dockerfile.j2)
...
Other tags are rolling release rebuild by [Travis](https://travis-ci.org/alvistack/docker-jira) in weekly basis. Thus using these tags will ensure you are running the latest packages provided by the base image project.
