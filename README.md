...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/jira-9.6.svg)](https://hub.docker.com/r/alvistack/jira-9.6)
...
-   [`alvistack/jira-9.5`](https://hub.docker.com/r/alvistack/jira-9.5)
    -   [`packer/docker-9.5/packer.json`](https://github.com/alvistack/docker-jira/blob/master/packer/docker-9.5/packer.json)
...
Start Atlassian Jira Server:
    ...
    # Pull latest image
    docker pull alvistack/jira-9.6
